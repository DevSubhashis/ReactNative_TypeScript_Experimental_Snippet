...
const CategoryBox: React.FC<CategoryBoxProps> = ({ style, ...props }) => {
  ...
  return (
    ...
    >
      <View
        style={[
          { ...layoutStyle, borderColor: '#fff', borderWidth: 3, borderRadius: 15, justifyContent: 'center', alignItems: 'center' },
          style,
        ]}
        {...props}
      >
        <Image
          source={Images.W1}
          style={{ height: layoutStyle.height - 10, width: layoutStyle.width - 10, borderRadius: 15 }}
        />
      </View>
      <View
        style={{
