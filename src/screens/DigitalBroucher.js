        ...
        <View style={{ flex: 1, backgroundColor: Colors.violet, width: windowWidth }} onLayout={onLayout}>
            ...
            <View style={{ flexDirection: "row", padding: 50, flex: 1 }}>
                ...
                <View style={{ flex: .5 }}>
                    ...
                    ></TextInput>
                    <Spacer height={30} />
                    <AppText style={{ fontSize: hp(2.3), color: Colors.white }}>
                        Send a copy to a colleague:
                    </AppText>
                    <Spacer height={10} />
                    <TextInput
                        style={{
                  ...
                  <Spacer height={20} />
                    <Button style={{ width: wp(15) }} onPress={() => { alert("123"); }} backgroundColor={Colors.green}>
                        <AppText style={{ fontSize: hp(2.5), color: Colors.white, fontWeight: "bold" }}>Send</AppText>
                    </Button>
